...
of credit history [^1](#f1). As such, we anticipate a significant negative 
...
link on Coursera Data Analysis Project 1 web page [^2](#f2) on November 14, 2013 
...
[^3](#f3). We identified no missing values in this dataset.
...
Given that the range of FICO scores is between 300 and 850[^4](#f4), through 
...
<a name="f1">[1]</a>: http://en.wikipedia.org/wiki/Credit_score_in_the_United_States

<a name="f2">[2]</a>: `r dataRdaUrl`

<a name="f3">[3]</a>: `r codebookUrl`

<a name="f4">[4]</a>: http://en.wikipedia.org/wiki/Credit_score_in_the_United_States#FICO_score_ranges
